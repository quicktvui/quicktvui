<template>
  <div class="es-sdk-root-css">
    <qt-animation ref="animation_view_rotation" class="animation_view_rotation">
      <div class="animation_inner_view_class" />
    </qt-animation>

    <qt-animation ref="star_view_animation" class="animation_view_star_css">
      <img class="animation_inner_view_class" :src="require('../../assets/star.png')" />
    </qt-animation>
...
export default defineComponent({
  ...
  setup() {
    ...
    function playStarAnim() {
      ...
      star_view_animation.value?.playTogether('translation', ['4', '5', '6'])
