...
import qt_ul_selections_page from './qt-ul-selections-page'
...
import qt_ul_load_page_page from './qt-ul-load-page'
...
const QTULPageList = {
  ...
  qt_ul_selections_page: {
    name: '选集',
    component: qt_ul_selections_page,
  },
  ...
  qt_ul_template_page: {
    name: 'TemplateOnly',
    component: qt_ul_template_page,
  },
  qt_ul_post_delay_page: {
    name: 'PostDelay',
    component: qt_ul_post_delay_page,
  },
  qt_ul_update_page: {
    name: '更新',
