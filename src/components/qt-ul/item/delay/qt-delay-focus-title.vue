<template>
  <div
    class="qt-ui-poster-item-focus-title-css"
    :style="{
      width: titleFocusStyle.width,
      height: titleFocusStyle.height,
  ...
  >
    ...
    >
      ...
      <qt-text
        ...
        :style="{
          width: focusTitle.style.width,
          height: focusTitle.style.height,
      ...
      <qt-text
        ...
        :style="{
          width: subTitle.style.width,
          height: subTitle.style.height,
          color: `${subTitleColor}`,
          backgroundColor: 'transparent',
        }"
        :text="subTitle.text"
