  ...
  <qt-view class="es-sdk-root-css">
    ...
    <qt-view class="quick-list-view">
      ...
      >
        ...
        >
          <div flexStyle="${style}" :clipChildren="true" style="background-color: transparent">
            <qt-list-view
        ...
        >
          ...
          >
            <qt-indicator-list-view
              ...
              :isAutoLoop="true"
              :loopInterval="1000"
              :setIndicatorTitle="'标题111标题111标题111标题111标题111'"
              :drawBackground="true"
              flexStyle="${style}"
              indList="${itemList}"
            >
        ...
        >
          ...
          >
            <qt-indicator-list-view
              ...
              :setIndicatorEnable="true"
              :isAutoLoop="true"
              :setIndicatorTitle="'标题222标题222标题222标题222标题222'"
    ...
    function onPageIndexFunction(e) {
      toast.showToast(
        '----->' +
          e.currentIndex +
          '------->' +
          JSON.stringify(e.currentList.image) +
          e.currentList.type
      )
    }
