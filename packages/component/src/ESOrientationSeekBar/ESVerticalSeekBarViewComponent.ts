...
function registerESVerticalSeekBarViewComponent(app: ESApp) {
  const VerticalSeekBarViewComponent = {
    component: {
  ...
  registerElement('ESVerticalSeekBarViewComponent', VerticalSeekBarViewComponent)

  const VerticalSeekBarViewImpl = defineComponent({
    emits: ['focus', 'seek-change'],
    setup(props, context) {
      const viewRef = ref()
      ...
      function requestFocus() {
        Native.callUIFunction(viewRef.value, 'requestFocus', [], (res) => {})
      }
      ...
      function setOrientation(orientation: number) {
        Native.callUIFunction(viewRef.value, 'setOrientation', [orientation], (value) => {})
      }

      function setTickMarkDirection(tickMarkDirection: number) {
        Native.callUIFunction(
          viewRef.value,
          'setTickMarkDirection',
          [tickMarkDirection],
          (value) => {}
        )
      }

      function setIndicatorTextOrientation(orientation: number) {
        Native.callUIFunction(
          viewRef.value,
          'setIndicatorTextOrientation',
          [orientation],
          (value) => {}
        )
      }

      function setLeftIndicatorTextOrientation(orientation: number) {
        Native.callUIFunction(
          viewRef.value,
          'setLeftIndicatorTextOrientation',
          [orientation],
          (value) => {}
        )
      }

      function setRightIndicatorTextOrientation(orientation: number) {
        Native.callUIFunction(
          viewRef.value,
          'setRightIndicatorTextOrientation',
          [orientation],
          (value) => {}
        )
      }
      ...
      return () => {
        return h('ESVerticalSeekBarViewComponent', {
          ref: viewRef,
          onFocus: (evt) => {
            context.emit('focus', evt)
          },
          onSeekBarChange: (evt) => {
            context.emit('seek-change', evt)
          },
        })
      }
    },
  })
  app.component('es-vertical-seek-bar', VerticalSeekBarViewImpl)
}

export default registerESVerticalSeekBarViewComponent
