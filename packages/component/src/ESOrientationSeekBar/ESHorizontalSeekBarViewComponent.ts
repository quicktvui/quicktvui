...
function registerESHorizontalSeekBarViewComponent(app: ESApp) {
  const HorizontalSeekBarViewComponent = {
    component: {
  ...
  registerElement('ESHorizontalSeekBarViewComponent', HorizontalSeekBarViewComponent)

  const HorizontalSeekBarViewImpl = defineComponent({
  ...
  app.component('es-horizontal-seek-bar', HorizontalSeekBarViewImpl)
}

export default registerESHorizontalSeekBarViewComponent
