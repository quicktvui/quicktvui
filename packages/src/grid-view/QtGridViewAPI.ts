...
export function createQtGridViewAPI(viewAPI: QtViewAPI, listViewAPI: QtBaseListViewAPI): QtGridViewAPI {
  ...
  function setItemSelected(instance: Ref<QTIGridView | undefined>, position: number, requestFocus: boolean): void {
    instance.value?.setItemSelected(position, requestFocus)
  }

  function scrollToSelected(instance: Ref<QTIGridView | undefined>, position: number, requestFocus: boolean): void {
