...
export interface QtMediaSeriesAPI extends Omit<QtViewAPI, 'requestFocus'> {
  ...
  setInitData(instance: Ref<QTIMediaSeries | undefined>, type: QTMediaSeriesType,
              group: QTMediaSeriesGroup,
              styleType: QTMediaSeriesStyleType,
              data: QTMediaSeriesData): void

  setVisible(instance: Ref<QTIMediaSeries | undefined>, visible: boolean): void

  setPageData(instance: Ref<QTIMediaSeries | undefined>, page: number, data: Array<QTMediaSeries>): void

  scrollTo(instance: Ref<QTIMediaSeries | undefined>, position: number): void

  scrollToWithOffset(instance: Ref<QTIMediaSeries | undefined>, position: number, offset: number, anim: boolean): void
...
export function createQtMediaSeriesAPI(viewAPI: QtViewAPI): QtMediaSeriesAPI {
  ...
  function setInitData(instance: Ref<QTIMediaSeries | undefined>,
  ...
  function setPageData(instance: Ref<QTIMediaSeries | undefined>, page: number, data: Array<QTMediaSeries>): void {
  ...
  function scrollToWithOffset(instance: Ref<QTIMediaSeries | undefined>, position: number, offset: number, anim: boolean): void {
