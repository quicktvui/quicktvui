...
function registerQTProgressBarView(app: ESApp) {
  const ProgressBarView = defineComponent({
    ...
    setup(props, context) {
      ...
      function setProgress(progress: number) {
        Native.callUIFunction(viewRef.value, 'setProgress', [progress], (res) => {
        });
      }

      function setSecondProgress(progress: number) {
        Native.callUIFunction(viewRef.value, 'setSecondProgress', [progress], (res) => {
        });
      }

      function show(value: boolean) {
        Native.callUIFunction(viewRef.value, 'show', [value], (res) => {
        });
      }

      function setMaxProgress(progress: number) {
        Native.callUIFunction(viewRef.value, 'setMaxProgress', [progress], (res) => {
        });
      }
      ...
      function setProgressDefaultColor(defaultProgressColor: number) {
        Native.callUIFunction(viewRef.value, 'setProgressDefaultColor', [defaultProgressColor], (value) => {
        });
      }

      function setProgressDrawable(progressDrawable: ESGradient) {
        Native.callUIFunction(viewRef.value, 'setProgressDrawable', [progressDrawable], (value) => {
        });
      }

      function setProgressDefaultDrawable(progressDefaultDrawable: ESGradient) {
        Native.callUIFunction(viewRef.value, 'setProgressDefaultDrawable', [progressDefaultDrawable], (value) => {
        });
      }
      ...
      function setProgressDefaultUrl(progressDefaultUrl: string) {
        Native.callUIFunction(viewRef.value, 'setProgressDefaultUrl', [progressDefaultUrl], (value) => {
        });
      }
      ...
      function showLeftIndicator(showLeftIndicator: boolean) {
        Native.callUIFunction(viewRef.value, 'showLeftIndicator', [showLeftIndicator], (value) => {
        });
      }

      function showRightIndicator(showRightIndicator: boolean) {
        Native.callUIFunction(viewRef.value, 'showRightIndicator', [showRightIndicator], (value) => {
        });
      }

      function setIndicatorShowMode(indicatorShowMode: number) {
        Native.callUIFunction(viewRef.value, 'setIndicatorShowMode', [indicatorShowMode], (value) => {
        });
      }

      function setLeftIndicatorShowMode(indicatorShowMode: number) {
        Native.callUIFunction(viewRef.value, 'setLeftIndicatorShowMode', [indicatorShowMode], (value) => {
        });
      }

      function setRightIndicatorShowMode(indicatorShowMode: number) {
        Native.callUIFunction(viewRef.value, 'setRightIndicatorShowMode', [indicatorShowMode], (value) => {
        });
      }
      ...
      function setLeftIndicatorWidth(indicatorWidth: number) {
        Native.callUIFunction(viewRef.value, 'setLeftIndicatorWidth', [indicatorWidth], (value) => {
        });
      }

      function setRightIndicatorWidth(indicatorWidth: number) {
        Native.callUIFunction(viewRef.value, 'setRightIndicatorWidth', [indicatorWidth], (value) => {
        });
      }
      ...
      function setLeftIndicatorHeight(indicatorHeight: number) {
        Native.callUIFunction(viewRef.value, 'setLeftIndicatorHeight', [indicatorHeight], (value) => {
        });
      }

      function setRightIndicatorHeight(indicatorHeight: number) {
        Native.callUIFunction(viewRef.value, 'setRightIndicatorHeight', [indicatorHeight], (value) => {
        });
      }

      function setIndicatorTextDecimalFormat(formatPattern: string) {
        Native.callUIFunction(viewRef.value, 'setIndicatorTextDecimalFormat', [formatPattern], (value) => {
        });
      }

      function setLeftIndicatorTextDecimalFormat(formatPattern: string) {
        Native.callUIFunction(viewRef.value, 'setLeftIndicatorTextDecimalFormat', [formatPattern], (value) => {
        });
      }

      function setRightIndicatorTextDecimalFormat(formatPattern: string) {
        Native.callUIFunction(viewRef.value, 'setRightIndicatorTextDecimalFormat', [formatPattern], (value) => {
        });
      }

      function setIndicatorTextStringFormat(formatPattern: string) {
        Native.callUIFunction(viewRef.value, 'setIndicatorTextStringFormat', [formatPattern], (value) => {
        });
      }

      function setLeftIndicatorTextStringFormat(formatPattern: string) {
        Native.callUIFunction(viewRef.value, 'setLeftIndicatorTextStringFormat', [formatPattern], (value) => {
        });
      }

      function setRightIndicatorTextStringFormat(formatPattern: string) {
        Native.callUIFunction(viewRef.value, 'setRightIndicatorTextStringFormat', [formatPattern], (value) => {
        });
      }
      ...
      function setLeftIndicatorMargin(indicatorMargin: number) {
        Native.callUIFunction(viewRef.value, 'setLeftIndicatorMargin', [indicatorMargin], (value) => {
        });
      }

      function setRightIndicatorMargin(indicatorMargin: number) {
        Native.callUIFunction(viewRef.value, 'setRightIndicatorMargin', [indicatorMargin], (value) => {
        });
      }

      function setIndicatorPaddingBottom(indicatorPaddingBottom: number) {
        Native.callUIFunction(viewRef.value, 'setIndicatorPaddingBottom', [indicatorPaddingBottom], (value) => {
        });
      }

      function setLeftIndicatorPaddingBottom(indicatorPaddingBottom: number) {
        Native.callUIFunction(viewRef.value, 'setLeftIndicatorPaddingBottom', [indicatorPaddingBottom], (value) => {
        });
      }

      function setRightIndicatorPaddingBottom(indicatorPaddingBottom: number) {
        Native.callUIFunction(viewRef.value, 'setRightIndicatorPaddingBottom', [indicatorPaddingBottom], (value) => {
        });
      }

      function setIndicatorPaddingTop(indicatorPaddingTop: number) {
        Native.callUIFunction(viewRef.value, 'setIndicatorPaddingTop', [indicatorPaddingTop], (value) => {
        });
      }

      function setLeftIndicatorPaddingTop(indicatorPaddingTop: number) {
        Native.callUIFunction(viewRef.value, 'setLeftIndicatorPaddingTop', [indicatorPaddingTop], (value) => {
        });
      }

      function setRightIndicatorPaddingTop(indicatorPaddingTop: number) {
        Native.callUIFunction(viewRef.value, 'setRightIndicatorPaddingTop', [indicatorPaddingTop], (value) => {
        });
      }

      function setIndicatorPaddingLeft(indicatorPaddingLeft: number) {
        Native.callUIFunction(viewRef.value, 'setIndicatorPaddingLeft', [indicatorPaddingLeft], (value) => {
        });
      }

      function setLeftIndicatorPaddingLeft(indicatorPaddingLeft: number) {
        Native.callUIFunction(viewRef.value, 'setLeftIndicatorPaddingLeft', [indicatorPaddingLeft], (value) => {
        });
      }

      function setRightIndicatorPaddingLeft(indicatorPaddingLeft: number) {
        Native.callUIFunction(viewRef.value, 'setRightIndicatorPaddingLeft', [indicatorPaddingLeft], (value) => {
        });
      }

      function setIndicatorPaddingRight(indicatorPaddingRight: number) {
        Native.callUIFunction(viewRef.value, 'setIndicatorPaddingRight', [indicatorPaddingRight], (value) => {
        });
      }

      function setLeftIndicatorPaddingRight(indicatorPaddingRight: number) {
        Native.callUIFunction(viewRef.value, 'setLeftIndicatorPaddingRight', [indicatorPaddingRight], (value) => {
        });
      }

      function setRightIndicatorPaddingRight(indicatorPaddingRight: number) {
        Native.callUIFunction(viewRef.value, 'setRightIndicatorPaddingRight', [indicatorPaddingRight], (value) => {
        });
      }

      function setIndicatorBackgroundColor(indicatorBackgroundColor: number) {
        Native.callUIFunction(viewRef.value, 'setIndicatorBackgroundColor', [indicatorBackgroundColor], (value) => {
        });
      }

      function setLeftIndicatorBackgroundColor(indicatorBackgroundColor: number) {
        Native.callUIFunction(viewRef.value, 'setLeftIndicatorBackgroundColor', [indicatorBackgroundColor], (value) => {
        });
      }

      function setRightIndicatorBackgroundColor(indicatorBackgroundColor: number) {
        Native.callUIFunction(viewRef.value, 'setRightIndicatorBackgroundColor', [indicatorBackgroundColor], (value) => {
        });
      }
      ...
      function setLeftIndicatorRadius(indicatorRadius: number) {
        Native.callUIFunction(viewRef.value, 'setLeftIndicatorRadius', [indicatorRadius], (value) => {
        });
      }

      function setRightIndicatorRadius(indicatorRadius: number) {
        Native.callUIFunction(viewRef.value, 'setRightIndicatorRadius', [indicatorRadius], (value) => {
        });
      }

      function setIndicatorTextSize(indicatorTextSize: number) {
        Native.callUIFunction(viewRef.value, 'setIndicatorTextSize', [indicatorTextSize], (value) => {
        });
      }

      function setLeftIndicatorTextSize(indicatorTextSize: number) {
        Native.callUIFunction(viewRef.value, 'setLeftIndicatorTextSize', [indicatorTextSize], (value) => {
        });
      }

      function setRightIndicatorTextSize(indicatorTextSize: number) {
        Native.callUIFunction(viewRef.value, 'setRightIndicatorTextSize', [indicatorTextSize], (value) => {
        });
      }

      function setIndicatorTextColor(indicatorTextColor: number) {
        Native.callUIFunction(viewRef.value, 'setIndicatorTextColor', [indicatorTextColor], (value) => {
        });
      }

      function setLeftIndicatorTextColor(indicatorTextColor: number) {
        Native.callUIFunction(viewRef.value, 'setLeftIndicatorTextColor', [indicatorTextColor], (value) => {
        });
      }

      function setRightIndicatorTextColor(indicatorTextColor: number) {
        Native.callUIFunction(viewRef.value, 'setRightIndicatorTextColor', [indicatorTextColor], (value) => {
        });
      }

      function setIndicatorArrowSize(indicatorArrowSize: number) {
        Native.callUIFunction(viewRef.value, 'setIndicatorArrowSize', [indicatorArrowSize], (value) => {
        });
      }

      function setLeftIndicatorArrowSize(indicatorArrowSize: number) {
        Native.callUIFunction(viewRef.value, 'setLeftIndicatorArrowSize', [indicatorArrowSize], (value) => {
        });
      }

      function setRightIndicatorArrowSize(indicatorArrowSize: number) {
        Native.callUIFunction(viewRef.value, 'setRightIndicatorArrowSize', [indicatorArrowSize], (value) => {
        });
      }

      function setIndicatorDrawable(indicatorDrawable: ESGradient) {
        Native.callUIFunction(viewRef.value, 'setIndicatorDrawable', [indicatorDrawable], (value) => {
        });
      }

      function setLeftIndicatorDrawable(leftIndicatorDrawable: ESGradient) {
        Native.callUIFunction(viewRef.value, 'setLeftIndicatorDrawable', [leftIndicatorDrawable], (value) => {
        });
      }

      function setRightIndicatorDrawable(rightIndicatorDrawable: ESGradient) {
        Native.callUIFunction(viewRef.value, 'setRightIndicatorDrawable', [rightIndicatorDrawable], (value) => {
        });
      }
      ...
      function setLeftIndicatorUrl(leftIndicatorUrl: string) {
        Native.callUIFunction(viewRef.value, 'setLeftIndicatorUrl', [leftIndicatorUrl], (value) => {
        });
      }

      function setRightIndicatorUrl(rightIndicatorUrl: string) {
        Native.callUIFunction(viewRef.value, 'setRightIndicatorUrl', [rightIndicatorUrl], (value) => {
        });
      }
      ...
      function setLeftThumbScaleRatio(thumbScaleRatio: number) {
        Native.callUIFunction(viewRef.value, 'setLeftThumbScaleRatio', [thumbScaleRatio], (value) => {
        });
      }

      function setRightThumbScaleRatio(thumbScaleRatio: number) {
        Native.callUIFunction(viewRef.value, 'setRightThumbScaleRatio', [thumbScaleRatio], (value) => {
        });
      }
      ...
      function setThumbInactivatedDrawable(drawable: ESGradient) {
        Native.callUIFunction(viewRef.value, 'setThumbInactivatedDrawable', [drawable], (value) => {
        });
      }

      function setLeftThumbInactivatedDrawable(drawable: ESGradient) {
        Native.callUIFunction(viewRef.value, 'setLeftThumbInactivatedDrawable', [drawable], (value) => {
        });
      }

      function setRightThumbInactivatedDrawable(drawable: ESGradient) {
        Native.callUIFunction(viewRef.value, 'setRightThumbInactivatedDrawable', [drawable], (value) => {
        });
      }
      ...
      function setTickMarkLayoutGravity(tickMarkLayoutGravity: number) {
        Native.callUIFunction(viewRef.value, 'setTickMarkLayoutGravity', [tickMarkLayoutGravity], (value) => {
        });
      }

      function setTickMarkTextArray(tickMarkTextArray: Array<string>) {
        Native.callUIFunction(viewRef.value, 'setTickMarkTextArray', [tickMarkTextArray], (value) => {
        });
      }

      function setTickMarkTextMargin(tickMarkTextMargin: number) {
        Native.callUIFunction(viewRef.value, 'setTickMarkTextMargin', [tickMarkTextMargin], (value) => {
        });
      }

      function setTickMarkTextSize(tickMarkTextSize: number) {
        Native.callUIFunction(viewRef.value, 'setTickMarkTextSize', [tickMarkTextSize], (value) => {
        });
      }

      function setTickMarkTextColor(tickMarkTextColor: number) {
        Native.callUIFunction(viewRef.value, 'setTickMarkTextColor', [tickMarkTextColor], (value) => {
        });
      }

      function setTickMarkInRangeTextColor(tickMarkInRangeTextColor: number) {
        Native.callUIFunction(viewRef.value, 'setTickMarkInRangeTextColor', [tickMarkInRangeTextColor], (value) => {
        });
      }
      ...
      function setStepsAutoBonding(stepsAutoBonding: boolean) {
        Native.callUIFunction(viewRef.value, 'setStepsAutoBonding', [stepsAutoBonding], (value) => {
        });
      }
  ...
  app.component('qt-progress-bar', ProgressBarView);
}
