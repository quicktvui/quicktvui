...
export class QtReactiveEffect {
  active = true
  deeps:Set<any>[] = [];
  constructor(public fn:TrunFn, public scheduler?:TrunFn){}
  run(){
    if(!this.active){
      return this.fn()
    }
 ...
 * 触发依赖更新
 */
export function qtTriggerEffects(effects:any, target?:any, prop?:any, newValue?:any, type?:any, oldValue?:any){
