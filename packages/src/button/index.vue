<template>
  <div ref="buttonRef"
    ...
    <!-- gradient -->
    <div v-if="gradientFocusBackground" class="button-gradient-background-css"
         :gradientBackground="gradientFocusBackground"
         :focusable="false"
         showOnState="focused"/>
    <div v-if="gradientSelectedBackground" class="button-gradient-background-css"
         :gradientBackground="gradientSelectedBackground"
         :focusable="false"
         showOnState="selected"/>
    <div v-if="gradientBackground" class="button-gradient-background-css"
    ...
    <div :duplicateParentState="true"
         ...
         :class="[
          'quick-button-icon-parent',
           size ? 'quick-button-icon--parent' + size : ''
          ]"
      ...
      <img :style="iconStyle"
          ...
          'quick-button-icon',
           ...
           :src="enableFlexStyle ? '${' + icon + '}' : icon" showOnState="normal"/>

      <img :style="focusIconStyle ? focusIconStyle : iconStyle"
           flexStyle="${iconStyle}"
           :class="[
          'quick-button-icon',
           size ? 'quick-button-icon--' + size : '',
           ...
           :src="enableFlexStyle ? '${' + focusIcon + '}' : focusIcon" showOnState="focused"/>
    </div>
    <!-- ------------------------------------------------------------------- -->
    <!-- text -->
    <text-view :style="textStyle" v-if="enableFlexStyle" duplicateParentState :class="[
    ...
    <span :style="textStyle" v-else-if="text && !$slots.default " duplicateParentState
          :class="[
          size ? 'quick-button-text--' + size : '',
          {
            'is-disabled-text': disabled,
