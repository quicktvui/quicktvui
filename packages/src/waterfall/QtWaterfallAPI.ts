...
export function createQtWaterfallAPI(viewAPI: QtViewAPI, listViewAPI: QtBaseListViewAPI): QtWaterfallAPI {
  ...
  function setSectionList(instance: Ref<QTIWaterfall | undefined>, sections: Array<QTWaterfallSection>): void {
    instance.value?.setSectionList(sections)
  }

  function addSectionList(instance: Ref<QTIWaterfall | undefined>, sections: Array<QTWaterfallSection>): void {
    instance.value?.addSectionList(sections)
  }

  function deleteSection(instance: Ref<QTIWaterfall | undefined>, sectionIndex: number, count: number): void {
    instance.value?.deleteSection(sectionIndex, count)
  }

  function updateSection(instance: Ref<QTIWaterfall | undefined>, sectionIndex: number, section: QTWaterfallSection): void {
    instance.value?.updateSection(sectionIndex, section)
  }

  function updateSectionList(instance: Ref<QTIWaterfall | undefined>, sectionIndex: number, count: number, sectionList: Array<QTWaterfallSection>): void {
    instance.value?.updateSectionList(sectionIndex, count, sectionList)
  }

  function getSection(instance: Ref<QTIWaterfall | undefined>, sectionIndex: number): QTWaterfallSection | undefined {
    return instance.value?.getSection(sectionIndex)
  }

  //---------------------------------------------------------------------
  function addItemList(instance: Ref<QTIWaterfall | undefined>, sectionIndex: number, itemList: Array<QTWaterfallItem>): void {
    instance.value?.addItemList(sectionIndex, itemList)
  }

  function deleteItem(instance: Ref<QTIWaterfall | undefined>, sectionIndex: number, itemIndex: number, count: number): void {
    instance.value?.deleteItem(sectionIndex, itemIndex, count)
  }

  function updateItem(instance: Ref<QTIWaterfall | undefined>, sectionIndex: number, itemIndex: number, item: QTWaterfallItem): void {
    instance.value?.updateItem(sectionIndex, itemIndex, item)
  }

  function updateItemList(instance: Ref<QTIWaterfall | undefined>, sectionIndex: number, itemIndex: number, count: number, itemList: Array<QTWaterfallItem>): void {
    instance.value?.updateItemList(sectionIndex, itemIndex, count, itemList)
  }

  function getItem(instance: Ref<QTIWaterfall | undefined>, sectionIndex: number, itemIndex: number): QTWaterfallItem | undefined {
    if (instance.value) {
