  ...
  function setSelectChildPosition(
    ...
    if (isString(instance)) {
      Native.callNative(QT_API_MODULE, QT_CALL_UI_FUNCTION, [
        instance,
        'setSelectChildPosition',
        [position, changeTargetFocusChild],
      ])
    } else if (isRef(instance)) {
  ...
  function setListDataWithParams(
    ...
    if (isString(instance)) {
      Native.callNative(QT_API_MODULE, QT_CALL_UI_FUNCTION, [
        instance,
        'setListDataWithParams',
        [itemList, autoChangeVisible, useDiff],
      ])
    } else if (isRef(instance)) {
  ...
  function scrollToFocus(
    ...
    if (isString(instance)) {
      Native.callNative(QT_API_MODULE, QT_CALL_UI_FUNCTION, [
        instance,
        'scrollToFocus',
        [position, scrollOffset, delay, target],
      ])
    } else if (isRef(instance)) {
  ...
  function updateItemProps(
    ...
    if (isString(instance)) {
      Native.callNative(QT_API_MODULE, QT_CALL_UI_FUNCTION, [
        instance,
        'updateItemProps',
        [name, position, dataToUpdate, updateView],
      ])
    } else if (isRef(instance)) {
