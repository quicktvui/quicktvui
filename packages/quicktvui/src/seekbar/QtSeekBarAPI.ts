...
export interface QtSeekBarAPI extends QtBaseViewAPI {
  ...
  setProgressDrawable(
    instance: string | Ref<QTISeekBar | undefined>,
    progressDrawable: ESGradient
  ): void

  setProgressDefaultDrawable(
    instance: string | Ref<QTISeekBar | undefined>,
    progressDefaultDrawable: ESGradient
  ): void
  ...
  setIndicatorDrawable(
    instance: string | Ref<QTISeekBar | undefined>,
    indicatorDrawable: ESGradient
  ): void

  setLeftIndicatorDrawable(
    instance: string | Ref<QTISeekBar | undefined>,
    leftIndicatorDrawable: ESGradient
  ): void

  setRightIndicatorDrawable(
    instance: string | Ref<QTISeekBar | undefined>,
    rightIndicatorDrawable: ESGradient
  ): void
  ...
  setStepsDrawable(
    instance: string | Ref<QTISeekBar | undefined>,
    drawableArray: Array<ESGradient>
  ): void
